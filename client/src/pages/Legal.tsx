...
export function MedicalDisclaimer() {
  return (
    <LegalLayout title="Medical Disclaimer" subtitle="Please read this carefully before using PeptidePilot">
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
          <p className="text-amber-900 font-medium text-sm">
            The information provided by PeptidePilot is for educational and informational purposes only. It is not intended to be a substitute for professional medical advice, diagnosis, or treatment.
          </p>
        </div>
        <p>PeptidePilot is an independent educational platform. We analyze publicly available research on peptide compounds and use a scoring algorithm to match your self-reported health profile to compounds that may be relevant to your goals. This is not a medical assessment.</p>
        ...
        <p>PeptidePilot does not endorse self-administration of injectable compounds without proper medical supervision. We strongly encourage all users to work with a qualified healthcare provider, particularly for injectable peptides, hormonal compounds, or protocols involving multiple compounds.</p>
        <p>The quiz results and recommendations generated by PeptidePilot are based on self-reported data and a proprietary scoring algorithm. They are not diagnostic tools and should not be used to diagnose, treat, cure, or prevent any disease or medical condition.</p>
