...
import { Beaker, DollarSign, Handshake, LayoutDashboard, LogOut, Mail, PanelLeft } from "lucide-react";
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-4 p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-muted-foreground">
            This workspace is limited to PeptidePilot admins. Ask the project owner to add your email to the admin allowlist.
          </p>
