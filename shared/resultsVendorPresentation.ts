...
export const resultsVendorPresentation: ResultsVendorPresentation[] = [
  ...
  },
  {
    ...
    trustSignals: ["USA made", "Support", "Fast shipping"],
  ...
  },
  {
    ...
    trustSignals: ["US Based", "Dedicated Concierge"],
  ...
  },
  {
    ...
    secondaryHeadline: "$179 per month all doses, no hidden fees",
    secondaryCtaLabel: "View Offer",
    sourceStatus: "manual-review",
  ...
  },
  {
    ...
    promo: "",
    trustSignals: ["Prepared by state licensed US pharmacies", "Patient care team", "Fast shipping"],
  ...
  },
  {
    ...
    trustSignals: ["Made in USA", "Support"],
